...
def contact():
    if request.method == 'POST':
        ...
        return '<h3>Our Flask Buttons<h3/> <form method="post" action="/"> <input type="submit" name="submit_button" value="MD5"> <input type="submit" name="submit_button" value="Factorial"> </form>'
